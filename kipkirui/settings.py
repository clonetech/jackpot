"""
Django settings for kipkirui project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'lj@fpp$g64kxdtg_=)gr8t0(_7ill-qbraz2=h3$xddh2uw#$%')

# SECURITY WARNING: don't run with debug turned on in production!
# DEBUG = True
DEBUG = bool( os.environ.get('DJANGO_DEBUG', True) )

ALLOWED_HOSTS = ['sportpesajp.herokuapp.com','127.0.0.1','http://www.sportpesajp.com']
...
WSGI_APPLICATION = 'kipkirui.wsgi.application'
